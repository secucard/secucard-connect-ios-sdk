#
# Be sure to run `pod lib lint SecucardConnectSDK.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "http://www.secucard.com/"
  ...
  s.source       = { :git => "https://github.com/secucard/secucard-connect-ios-sdk.git", :tag => s.version.to_s }
